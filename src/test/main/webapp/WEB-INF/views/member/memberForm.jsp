...
<div class="member-form-wrapper">
    <h3>회원가입</h3>
    <form name="memberForm" id="memberForm" method="post" action="${pageContext.request.contextPath}/member/register" oonsubmit="return validateForm()">
		<input type="hidden" id="_check_email" value="" />
        <table class="table">
            <tr>
                <td>이름</td>
                <td><input type="text" name="name" id="name" size="20" maxlength="10" required></td>
            </tr>
            <tr>
                <td>이메일</td>
                <td>
             ...
             <tr>
                <td>비밀번호</td>
                <td><input type="password" name="password" id="password" size="20" maxlength="20" required></td>
            </tr>
            <tr>
                <td>비밀번호 확인</td>
                <td><input type="password" name="repassword" id="repassword" size="20" maxlength="20" required></td>
            </tr>
            <tr>
                <td>전화번호</td>
                <td><input type="text" name="phone_number" id="phone_number" size="15" maxlength="15" required></td>
            </tr>
            <tr>
                <td>우편번호</td>
                <td>
            ...
            <tr>
                <td>계좌번호</td>
                <td><input type="text" name="account_number" id="account_number" maxlength="30" required></td>
            </tr>
            <tr>
                <td>회원 구분</td>
                <td>
